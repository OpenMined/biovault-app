...
export default function AncestryDNAWizard() {
	const { theme } = useTheme()
	const { trackEvent } = useAnalytics({
		trackScreenView: true,
		screenProperties: {
			screen: 'AncestryDNA_Support',
			...
			>
				<View style={{
					...
					<Text style={{
						...
						Support for AncestryDNA files is in development. Tap the button below to be notified when it&apos;s ready!
					</Text>
