...
export default function SequencingWizard() {
	const { theme } = useTheme()
	const { trackEvent } = useAnalytics({
		trackScreenView: true,
		screenProperties: {
			screen: 'Sequencing_Support',
			...
			>
				<View style={{
					...
					<Text style={{
						...
						Support for Sequencing.com files is in development. Tap the button below to be notified when it&apos;s ready!
					</Text>
