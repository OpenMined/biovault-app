...
// 		if (!fileData) {
// 			throw new Error(`Could not find genome file ${genomeFileName} in zip`)
// 		}
...
// 	// Look for header comments (unused but kept for reference)
...
// 		return parts.length >= 4 && parts[0] && parts[0].trim().startsWith('rs')
// 	})
